...
//------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	void GripLeft() { LeftMotionController->Grip(); }
	void ReleaseLeft() { LeftMotionController->Release(); }
	void GripRight() { RightMotionController->Grip(); }
	void ReleaseRight() { RightMotionController->Release(); }
	void BeginTelePort() ;
	void EndTeleport();
